                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4 mb-4">
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <p className="text-surface-500 text-xs uppercase tracking-widest">Reward</p>
                    </div>
                  </div>
            ...
            {quickStats.map((stat, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-surface-100 font-semibold uppercase tracking-wide text-sm">{stat.label}</p>
                    <p className="text-sm text-surface-500 font-display">{stat.value}</p>
                  </div>
                </div>
              </div>
            ))}
