  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 40px rgba(6, 182, 212, 0.5), 0 0 80px rgba(6, 182, 212, 0.3)',
        ...
        'card-hover': '0 10px 30px -5px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(6, 182, 212, 0.2)',
      ...
      clipPath: {
        ...
        'corner-cut-sm': 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))',
      },
    },
  },
  plugins: [],
