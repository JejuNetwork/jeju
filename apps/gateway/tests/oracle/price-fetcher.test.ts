...
describe('PriceFetcher', () => {
  describe('Manual Price Management', () => {
    ...
    test('should update manual price on subsequent sets', () => {
      const feedId = '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890' as Hex;
      const sources: PriceSourceConfig[] = [
        { type: 'manual', feedId, address: '0x0000000000000000000000000000000000000000', decimals: 8 },
      ];
  ...
  describe('Constructor', () => {
    test('should create instance with valid config', () => {
      const sources: PriceSourceConfig[] = [
        { type: 'manual', feedId: '0x1234' as Hex, address: '0x0', decimals: 8 },
      ];
    ...
    test('should create instance with multiple sources', () => {
      const sources: PriceSourceConfig[] = [
        { type: 'manual', feedId: '0x1111' as Hex, address: '0x0', decimals: 8 },
        { type: 'manual', feedId: '0x2222' as Hex, address: '0x0', decimals: 8 },
        { type: 'manual', feedId: '0x3333' as Hex, address: '0x0', decimals: 8 },
      ];
  ...
  describe('FetchPrice Error Cases', () => {
    test('should throw for unconfigured feed', async () => {
      ...
      await expect(
        priceFetcher.fetchPrice('0x9999999999999999999999999999999999999999999999999999999999999999' as Hex)
  ...
  describe('Price Data Structure', () => {
    test('should return correct PriceData fields', () => {
      const feedId = '0x4444444444444444444444444444444444444444444444444444444444444444' as Hex;
      const sources: PriceSourceConfig[] = [
  ...
  describe('Edge Cases', () => {
    test('should handle zero price', () => {
      const feedId = '0x5555555555555555555555555555555555555555555555555555555555555555' as Hex;
      const sources: PriceSourceConfig[] = [
        { type: 'manual', feedId, address: '0x0', decimals: 8 },
      ];
    ...
    test('should handle max uint256 values', () => {
      const feedId = '0x6666666666666666666666666666666666666666666666666666666666666666' as Hex;
      const sources: PriceSourceConfig[] = [
        { type: 'manual', feedId, address: '0x0', decimals: 8 },
      ];
