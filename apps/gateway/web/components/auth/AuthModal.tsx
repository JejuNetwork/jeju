import { useOAuth3 } from '../../lib/auth/oauth3-stub'
import { createSIWEMessage, formatSIWEMessage } from '../../lib/auth/siwe'
...
import { CHAIN_ID, OAUTH3_AGENT_URL } from '../../../lib/config'
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">to Gateway</p>
            </div>
          </div>
          <button
            type="button"
