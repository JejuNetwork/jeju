...
const API_PORT = Number(process.env.PORT) || 1422
...
async function main() {
  const host = getLocalhostHost()
  console.log('[VPN] Starting production server...')
  ...
  if (!ready) {
    console.error('[VPN] Failed to start server')
    cleanup()
    process.exit(1)
  }
  ...
  console.log('')
  console.log('╔════════════════════════════════════════════════════════════╗')
  console.log('║             VPN Production Server Ready                     ║')
  console.log('╠════════════════════════════════════════════════════════════╣')
