 ...
 *
 * Deploys Documentation to DWS infrastructure (static site to IPFS/CDN).
 */
...
async function ensureBuild(): Promise<void> {
  ...
  console.log('[Documentation] Build found')
}
...
async function setupCDN(
  ...
  const cdnConfig = {
    name: 'documentation',
    domain: 'docs.jejunetwork.org',
    spa: {
      enabled: false, // Vocs generates static pages
      fallback: '/404.html',
      routes: [],
    },
    assets,
    cacheRules: [
      ...
      { pattern: '/index.html', ttl: 300, staleWhileRevalidate: 3600 },
    ],
  }
...
async function deploy(): Promise<void> {
  console.log('╔════════════════════════════════════════════════════════════╗')
  console.log('║          Documentation Deployment to DWS                    ║')
  console.log('╚════════════════════════════════════════════════════════════╝')
  console.log('')
