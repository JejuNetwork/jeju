...
/** Generic SQLit query response shape */
export interface SQLitQueryResponse<T> {
  rows?: T[]
}

/** Check if value is a valid SQLit query response */
export function isSQLitQueryResponse<T>(
  data: unknown,
): data is SQLitQueryResponse<T> {
